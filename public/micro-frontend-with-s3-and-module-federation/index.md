---
title: "Micro-Frontend-With-S3-and-Module-Federation"
date: '2025-11-29'
...
![Micro Frontend Architecture](./micro-frontend-with-s3-and-module-federation/micro-frontend-architecture.png)
...
![S3](./micro-frontend-with-s3-and-module-federation/s3.png)
...
![cache-dependency](./micro-frontend-with-s3-and-module-federation/cache-dependency.png)

![s3-cache-bucket](./micro-frontend-with-s3-and-module-federation/s3-cache-bucket.png)
...
cache:
  paths:
    - '.turbo/**/*'
```
![cache-hit](./micro-frontend-with-s3-and-module-federation/cache-hit.png)

### Issues and Solution 

1. Bundle size issue

![cache-hit](./micro-frontend-with-s3-and-module-federation/bundle-size-issue.png)
...
![rollup-plugin-visualizer](./micro-frontend-with-s3-and-module-federation/rollup-plugin-visualizer.png)
...
![manual-chunk](./micro-frontend-with-s3-and-module-federation/manual-chunk.png)
...
![codebuild-compute](./micro-frontend-with-s3-and-module-federation/codebuild-compute.png)
